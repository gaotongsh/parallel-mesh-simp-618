...
#include "CMU462.h"  // Standard 462 Vectors, etc.
#include "vector3D.h"
#include "matrix4x4.h"
...
class HalfedgeMesh {
 public:
  ...
  /**
   * Remove a tetrahedron structure if it is connected to an edge.
   * This is called by collapseEdge and downsample.
   */
  set<EdgeIter> remove_tetrahedron(EdgeIter e);
